...
const EyeIcon = ({showPassword , showPasswordFn}) => {
    if(!showPassword) {
        return  (
            <div onClick={showPasswordFn} className='absolute top-12 right-4 hover:cursor-pointer hover:opacity-50 duration-300'>
